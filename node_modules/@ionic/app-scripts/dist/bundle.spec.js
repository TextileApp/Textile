...
describe('bundle task', function () {
    describe('bundle', function () {
        ...
        it('should return the value webpack task returns', function (done) {
            // arrange
    ...
    describe('bundleUpdate', function () {
        it('should return the value rollup returns', function (done) {
            // arrange
            spyOn(rollup, rollup.rollupUpdate.name).and.returnValue(Promise.resolve());
            var context = { bundler: Constants.BUNDLER_ROLLUP };
            var changedFiles = [];
            // act
            bundle.bundleUpdate(changedFiles, context).then(function () {
                // assert
        ...
        it('should return the value webpack returns', function (done) {
            // arrange
        ...
        it('should throw when webpack throws', function (done) {
            var errorText = 'simulating an error';
            try {
                // arrange
