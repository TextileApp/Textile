...
function generateContext(context) {
    ...
    var tsConfigPathValue = getConfigValue(context, '--tsconfig', null, Constants.ENV_TS_CONFIG, Constants.ENV_TS_CONFIG.toLowerCase(), path_1.join(context.rootDir, 'tsconfig.json'));
    setProcessEnvVar(Constants.ENV_TS_CONFIG, tsConfigPathValue);
    var appEntryPointPathValue = getConfigValue(context, '--appEntryPoint', null, Constants.ENV_APP_ENTRY_POINT, Constants.ENV_APP_ENTRY_POINT.toLowerCase(), path_1.join(context.srcDir, 'app', 'main.ts'));
