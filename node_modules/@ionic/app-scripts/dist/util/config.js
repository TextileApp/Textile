...
function generateContext(context) {
    ...
    var appNgModulePath = path_1.resolve(getConfigValue(context, '--appNgModulePath', null, Constants.ENV_APP_NG_MODULE_PATH, Constants.ENV_APP_NG_MODULE_PATH.toLowerCase(), path_1.join(context.srcDir, 'app', 'app.module.ts')));
    setProcessEnvVar(Constants.ENV_APP_NG_MODULE_PATH, appNgModulePath);
    logger_1.Logger.debug("appNgModulePath set to " + appNgModulePath);
    ...
    /* Experimental Flags */
    var experimentalParseDeepLinks = getConfigValue(context, '--experimentalParseDeepLinks', null, Constants.ENV_EXPERIMENTAL_PARSE_DEEPLINKS, Constants.ENV_EXPERIMENTAL_PARSE_DEEPLINKS.toLowerCase(), null);
    setProcessEnvVar(Constants.ENV_EXPERIMENTAL_PARSE_DEEPLINKS, experimentalParseDeepLinks);
    logger_1.Logger.debug("experimentalParseDeepLinks set to " + experimentalParseDeepLinks);
