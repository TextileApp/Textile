    ...
    var Animation = (function () {
        ...
        Animation.prototype._addProp = function (state, prop, val) {
            ...
            if (!fxProp) {
                ...
                fxProp = {
                    ...
                    wc: (shouldTrans ? dom_1.CSS.transform : prop)
                };
        ...
        Animation.prototype._progress = function (stepValue) {
            ...
            if (finalTransform.length) {
                ...
                var cssTransform = dom_1.CSS.transform;
        ...
        Animation.prototype._setTrans = function (dur, forcedLinearEasing) {
            ...
            var cssTransform = dom_1.CSS.transition;
            var cssTransitionDuration = dom_1.CSS.transitionDuration;
            var cssTransitionTimingFn = dom_1.CSS.transitionTimingFn;
            var eleStyle;
