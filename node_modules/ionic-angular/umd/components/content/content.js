...
(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define(["require", "exports", '@angular/core', '../app/app', '../../config/config', '../../util/dom-controller', '../ion', '../../util/util', '../../util/keyboard', '../../util/scroll-view', '../tabs/tabs', '../../util/dom', '../../navigation/view-controller'], factory);
    }
    ...
    var Content = (function (_super) {
        ...
        function Content(config, elementRef, renderer, _app, _keyboard, _zone, viewCtrl, _tabs, _dom) {
            ...
            this._scroll = new scroll_view_1.ScrollView(_dom);
        }
        ...
        Content.propDecorators = {
            ...
            'readReady': [{ type: core_1.Output },],
            'writeReady': [{ type: core_1.Output },],
