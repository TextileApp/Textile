(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define(["require", "exports", '@angular/core', '../content/content', '../../util/dom-controller', '../../util/util', '../../util/ui-event-manager', '../../platform/platform'], factory);
    }
    ...
    var Img = (function () {
        ...
        Img.prototype.ngAfterContentInit = function () {
            ...
            this._unreg = ui_event_manager_1.listenEvent(this._img, 'load', false, opts, function () {
