(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define(["require", "exports", '@angular/core', './activator', '../app/app', '../../config/config', '../../util/dom', './ripple', '../../util/ui-event-manager', '../../gestures/gesture-controller'], factory);
    }
    ...
    function setupTapClick(config, app, zone, gestureCtrl) {
        return function () {
